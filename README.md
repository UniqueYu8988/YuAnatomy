...
### 2026-09-07 专科学习补充
新增独立 Vertucci 八型窗口与四组双侧咀嚼肌预设。肌肉包12网格，285254面，gzip 3619994字节，单独署名 CC BY-SA 2.1 Japan；基础几何和髓腔不变。源数据/配准/复建流程参见 AGENTS.md 第10节。

### 间隙与测距修复
间隙改为离线骨肌约束的局部示意，支持8个区域及可能扩展关系选择；测距修复重测复位、剖切拾取和A/B锚点标注，并适配手机。方法、验证与局限见 [维护说明](docs/fascial-ruler.md)。
