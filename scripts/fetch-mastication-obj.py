...
out=root/'work/mastication-source/obj'
...
config=json.loads((root/'scripts/mastication-source.json').read_text(encoding='utf-8'))
atlas={'parts':[{'id':p['conceptId']} for p in config['parts']]+[{'id':i} for i in ['FMA52748','FMA52734','FMA53649','FMA53650']]}
def download(p):
